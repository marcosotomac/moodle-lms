...
use local_cmc_lms\form\company_form;
...
$company = $id ? $repository->get($id) : null;

$title = $id ? get_string('editcompany', 'local_cmc_lms') : get_string('addcompany', 'local_cmc_lms');
$PAGE->set_url(new moodle_url('/local/cmc_lms/company_edit.php', ['id' => $id]));
$PAGE->set_title($title);

$mform = new company_form($PAGE->url->out(false), ['id' => $id]);
if ($company) {
